...
-   Not all phenomena live on $\mathcal{R}^2$

-   Example: Traffic on roads, fish in a river, etc...
...
This model *cannot* be implemented in the original INLA framework. `inlabru` linearizes the problem and by an iterative prodedure is (*often*) able to estimate the parameters. You can read more here: [here](https://arxiv.org/abs/2407.00791)
...
-   Please get in touch if you have questions/problems to discuss :grinning:
