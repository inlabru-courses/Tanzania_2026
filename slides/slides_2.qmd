...
## One wrong way and two correct ways of coding{.smaller}
...
Obtain the posterior marginal for the _standard deviation_ of the random effect, compute its mean and median and sample from it.
