...
-   The mean of $u_i$ is equivalent to the mean of the effects over all neighbours, and the precision is proportional to the number of neighbours (e.g., if an area has many neighbors then its variance will be smaller)
:::
...
## What does it look like? {auto-animate="true"}
...
## What does it look like? {.smaller auto-animate="true"}
